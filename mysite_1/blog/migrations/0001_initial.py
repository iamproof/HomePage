...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_post', (
            ...
            ('link_description', self.gf('django.db.models.fields.CharField')(blank=True, max_length=140)),
        ))
        ...
        db.create_table('blog_comment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ('post_name', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
    ...
    models = {
        ...
        'blog.comment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post_name': ('django.db.models.fields.CharField', [], {'max_length': '140'}),
        ...
        'blog.post': {
            ...
            'link_description': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '140'}),
